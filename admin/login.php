...
if( isset($_POST['crm']) && !empty($_POST['crm']) ){
    ...
    try {
        $selecionar = $pdo->query("SELECT * FROM login WHERE crm = '$crm' AND senha = '$senha' ");
                                ...
                                <div class="p-5">
                                    ...
                                    <form method="POST" class="user">
                                        <div class="form-group">
                                            <input type="text" name="crm" class="form-control form-control-user"
                                    ...
                                    <hr>
                                    <div class="text-center">
                                        <a class="small" href="esqueceu_senha.php">Esqueceu a senha.?</a>
                                    </div>
                                    <div class="text-center">
                                        <a class="small" href="criar_Conta.php">Criar conta</a>
                                    </div>
                                </div>
                            </div>
                        </div>
